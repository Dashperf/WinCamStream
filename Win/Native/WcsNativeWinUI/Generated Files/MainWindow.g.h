...
namespace winrt::WcsNativeWinUI::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, WcsNativeWinUI::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = WcsNativeWinUI::MainWindow;
        ...
        {
            return L"WcsNativeWinUI.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::WcsNativeWinUI::factory_implementation
{
    ...
    {
        using instance_type = WcsNativeWinUI::MainWindow;
